...
async def start(message: Message):
    await bot.send_message(-1002318702468, 'Здравствуйте, уважаемые пользователи! Я снова работаю после долгого '
                                           'отдыха. Мои базы данных сброшены, но промпты частично сохранены. Спасибо '
                                           'за внимание. Добавьте, пожалуйста, ключи API.')
